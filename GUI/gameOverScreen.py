...
Grid.rowconfigure(gameoverscreen, 0, weight = 1)
Grid.columnconfigure(gameoverscreen, 0, weight = 1)
...
def aboutGame():
    pass
menubar = Menu(gameoverscreen)
filemenu = Menu(menubar, tearoff = 0)
filemenu.add_command(label = "Start New Game", command = startGame)

filemenu.add_separator()

filemenu.add_command(label = "Quit", command = gameoverscreen.quit)
...
gameoverscreen.config(menu = menubar)
#------------------------------------------------------------------------------
                                #Frames
welcome = ttk.Frame(gameoverscreen, borderwidth = 5, relief = "flat")
host = ttk.Frame(gameoverscreen, borderwidth = 5, relief = "sunken", width = 500, height = 500)
join = ttk.Frame(gameoverscreen, borderwidth = 5, relief = "sunken", width = 500, height = 500)
iigLogo = ttk.Frame(gameoverscreen)
