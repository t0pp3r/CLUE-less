...
# Dialog box for connection error
    ...
    def startGameButton(self):
        ...
        self.controller.host = True
        self.controller.connectionIP = "127.0.0.1"
        #self.controller.initClient("127.0.0.1", self.welcomescreen)
        self.welcomescreen.destroy()

    def joinGameButton(self):
        ip = self.ipAddress2.get()
        self.controller.connectionIP = ip
        self.controller.host = False
        self.welcomescreen.destroy()
        #tkMessageBox.showerror(title = "join game button", message = ip)
    ...
    def initScreen(self):  
        ...
        self.ipAddress2 = ttk.Entry(join, textvariable = ip)
        ...
        joinButton = Button(join, font = customFont2, text = "Join Game", command = self.joinGameButton)
        ...
        #Entry Boxes
        self.ipAddress2.grid(column = 2, row = 2, sticky = (N,W), padx = 5, pady = 5)
